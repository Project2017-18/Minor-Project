                                                ##Code for binary datasets in which class with label-2 is considered positive##
...
##        loo = LeaveOneOut()
        ...
        for train, test in ss:
            ...
            pre=precision_score(Y[test], prediction,pos_label=2)
            rec=recall_score(Y[test], prediction,pos_label=2)
            f=f1_score( Y[test], prediction,pos_label=2)
