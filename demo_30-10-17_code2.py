...
##            plt.gcf().clear()
        ...
        for elist ,name in zip([CMIM_ERROR_LIST,MRMR_ERROR_LIST,ICAP_ERROR_LIST,DISR_ERROR_LIST,MIM_ERROR_LIST,MIFS_ERROR_LIST,JMI_ERROR_LIST,CIFE_ERROR_LIST,LCSI_ERROR_LIST],feature_list):
            ...
            plt.legend(loc="lower right")
            plt.grid()
            plt.savefig('error_bar'+label+name+str(data)[:-4])
            plt.gcf().clear()
